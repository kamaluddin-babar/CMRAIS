...
@media only screen and (min-width: 1500px) {
    ...
    <style>
    .template-component-notice-content-left {width:180px !important;}
    .template-icon-feature-size-medium {width:180px}
    .template-icon-blog-date {color: #fff}
    
    .template-component-notice-content-center {
        background-color: #b1b1b1;
    }
    .template-component-notice-content-left, .template-component-notice-content-center {
        border-width: 1px 1px 1px 0px;
        border-style: solid;
        border-color: #d6d6d6;
    }
    .template-component-notice-content-left h6, .template-component-notice-content-center h6 {
        color: #fff;
        text-align: center;
    ...
    <div class="template-content-section template-main">
    	...
    	<div class="template-component-team template-component-team-style-1">
    		<div class="template-component-notice template-component-notice-style-1">
    				...
    				<div class="template-component-notice-content-center">
    					<h6>01:25am</h6>
    				</div>
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">12.07.2024 Friday Dr. Fazlu class niben class cllass start 9.am.</a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    				...
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">Dr. Yasin class nibe</a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    				...
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">Dr. Tarek class nibe</a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    				...
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">Frayday Institute open </a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    					<h6>January-05,2023</h6>
    				</div>
    				<div class="template-component-notice-content-center">
    					<h6>01:40am</h6>
    				</div>
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">আজকে &quot;P&apos; ব্যাচ এর ক্লাস বন্ধ। </a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    				...
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">আজকে &quot; MK&quot;ব্যাচ এর ক্লাস  হবে না। শুক্রবার সকাল ১০-১২টা পর্যন্ত ডাবল ক্লাস হবে। </a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    				...
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">আজকে &quot; MK&quot;ব্যাচ এর ক্লাস  হবে না।</a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    				...
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">10-12-2022 &quot; H &quot; Class off</a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    				...
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">Today &apos;M&apos; Batch class off</a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    				...
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">10/12/2022 Today all class off.</a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    					<h6>December-06,2022</h6>
    				</div>
    				<div class="template-component-notice-content-center">
    					<h6>07:18am</h6>
    				</div>
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">Today&quot; O&quot; batch class time 3.20 pm</a></h6>
    				</div>		
    			</div>
    			    			<div class="template-component-notice-content">
    				<div class="template-component-notice-content-left">
    				...
    				<div class="template-component-notice-content-right">
    					<h6><a href="https://aipmibd.com/uploads/AIPMI/notice/" target="_blank">25 Octobar  O Batch class off becouse bad weather</a></h6>
    				</div>		
    			</div>
    			    		</div>
    	</div>
