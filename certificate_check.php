...
@media only screen and (min-width: 1500px) {
	...
	<div class="template-header-bottom noprint" style="margin-top: 0px;">
	...
	<div class="template-content-section template-main">
		...
		<div class="template-component-contact-form">
			...
			<form>
				...
				<!-- Layout 50x50 -->
				<div class="template-layout-50x50 template-clear-fix noprint">
					...
					<div class="template-layout-column-right">
						...
						<!-- Name -->
						<div class="template-form-line template-state-block">
							<button class="template-component-button template-component-button-style-1" type="button"id="submit">Submit</button>
						</div>
				...
				<div class="template-form-line template-form-line-submit template-align-center">
					...
					<div class="template-state-block" id="showData"></div>
...
$(document).ready(function() {
    $('#submit').click(function(e) {
        rand = Math.random() * 1000000000000000000;
        $("#showData").html('<center><i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">Loading...</span></center>');
        
        id = $("#id").val();
        $.get("certificate_fetch.php?id="+id+"&r="+rand, function(data, status){
            $("#showData").html(data);
        });
    });
});
