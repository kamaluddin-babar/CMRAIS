            ...
            <table border="1" cellpadding="1" cellspacing="1" style="width:100%">
            	...
            	<tbody>
            	    <tr>
            	                ...
            	                <td>Diploma in Medical Science (D.M.S.)</td>
            	                <td style='text-align:center'>1 Year</td>
            	             </tr><tr>
            	                <td style='text-align:center'>2</td>
            	                <td>Diploma in Medical Pathology (D.M.P.)</td>
            	                <td style='text-align:center'>1 Year</td>
            	             </tr><tr>
            	                <td style='text-align:center'>3</td>
            	                <td>Diploma in Medical Nursing </td>
            	                <td style='text-align:center'>1 YEAR</td>
            	             </tr><tr>
            	                <td style='text-align:center'>4</td>
            	                <td>Diploma in Medical Pharmacy (D.M.P.)</td>
            	                <td style='text-align:center'>1 Year</td>
            	             </tr><tr>
            	                <td style='text-align:center'>5</td>
            	                <td>LOCAL MEDICAL ASSISTENT AND FAMILY PLANING ( LMAF)</td>
            	                ...
            	                <td>DIPLOMA IN DENTAL TECNOLOGIST </td>
            	                <td style='text-align:center'>6 months</td>
            	             </tr>            	</tbody>
            </table>
